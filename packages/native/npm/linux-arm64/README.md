# @delali/narsil-native-linux-arm64

[![npm](https://img.shields.io/npm/v/@delali/narsil-native-linux-arm64)](https://www.npmjs.com/package/@delali/narsil-native-linux-arm64)
[![license](https://img.shields.io/npm/l/@delali/narsil-native-linux-arm64)](https://github.com/assetcorp/narsil/blob/main/LICENSE)

This package holds the native search core of the Narsil search engine, compiled for Linux on 64-bit Arm.
...
This package holds a glibc build and a musl build, because Node may fail to load a binary linked against one C library under the other.
