...
export const tmdb: TmdbDataset = {
  ...
  tiers: [
    ...
    {
      label: '50k',
      file: 'movies-50000.json',
      url: `${RELEASE_BASE}/movies-50000.json`,
      sizeBytes: 29_574_832,
      docCount: 50_000,
    },
    {
      label: '100k',
      file: 'movies-100000.json',
      url: `${RELEASE_BASE}/movies-100000.json`,
      sizeBytes: 58_915_806,
      docCount: 100_000,
    },
  ],
  vectorFile: {
...
export const wikipedia: WikipediaDataset = {
  ...
  languages: [
    ...
    { code: 'tw', name: 'Twi', file: 'wikipedia-tw.json', url: null, sizeBytes: 7_782_400, docCount: 2_814 },
    {
      code: 'yo',
      name: 'Yoruba',
      file: 'wikipedia-yo.json',
      url: `${RELEASE_BASE}/wikipedia-yo.json`,
      sizeBytes: 12_468_067,
      docCount: 6_109,
    },
    {
      code: 'sw',
      name: 'Swahili',
      file: 'wikipedia-sw.json',
      url: `${RELEASE_BASE}/wikipedia-sw.json`,
      sizeBytes: 13_876_395,
      docCount: 8_432,
    },
    {
      code: 'ha',
      name: 'Hausa',
      file: 'wikipedia-ha.json',
      url: `${RELEASE_BASE}/wikipedia-ha.json`,
      sizeBytes: 20_298_419,
      docCount: 10_124,
    },
    {
      code: 'dag',
      name: 'Dagbani',
      file: 'wikipedia-dag.json',
      url: `${RELEASE_BASE}/wikipedia-dag.json`,
      sizeBytes: 22_011_752,
      docCount: 6_780,
    },
    {
      code: 'ig',
      name: 'Igbo',
      file: 'wikipedia-ig.json',
      url: `${RELEASE_BASE}/wikipedia-ig.json`,
      sizeBytes: 28_196_013,
      docCount: 11_234,
    },
    {
      code: 'en',
      name: 'English',
      file: 'wikipedia-en.json',
      url: `${RELEASE_BASE}/wikipedia-en.json`,
      sizeBytes: 94_218_652,
      docCount: 25_000,
    },
    {
      code: 'fr',
      name: 'French',
      file: 'wikipedia-fr.json',
      url: `${RELEASE_BASE}/wikipedia-fr.json`,
      sizeBytes: 167_726_466,
      docCount: 25_000,
    },
  ],
}
