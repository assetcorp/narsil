...
export interface NarsilServer {
   ...
   *
   * Shutting the engine down is what ends the request threads, so Node aborts
   ...
   * keeps running after the server closes, as in a process that fronts one
   * engine with two servers.
   */
