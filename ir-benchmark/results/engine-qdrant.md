...
- Captured: 2026-06-29T02:21:47.627683+00:00
...
| Dataset | nDCG@10 | Recall@100 | MAP | MRR |
|---|---|---|---|---|
| beir/nfcorpus/test | 0.3508 | 0.3242 | 0.1822 | 0.5655 |

Operational metrics:

| Dataset | Docs | Ingest docs/s | Build s | Index size | p50 ms | p95 ms | p99 ms |
|---|---|---|---|---|---|---|---|
| beir/nfcorpus/test | 3633 | 1646 | 2.21 | n/a | 0.80 | 0.96 | 1.42 |
