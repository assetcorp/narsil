...
Narsil standing: nDCG@10 rank 1/3 (best narsil 0.6239); server-side p50 latency rank 2/2 (fastest qdrant 0.19 ms, among engines whose server-side timing is above the measurement floor).
...
Narsil standing: nDCG@10 rank 2/3 (best qdrant 0.7155); server-side p50 latency rank 2/2 (fastest qdrant 0.22 ms, among engines whose server-side timing is above the measurement floor).
