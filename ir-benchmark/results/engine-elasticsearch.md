...
- Captured: 2026-06-29T15:27:53.798347+00:00
...
|---|---|---|---|---|---|---|---|
| beir/scifact/test | 5183 | 6312 | 0.82 | 7.0 MB | 0.00 | 0.00 | 0.00 |
| beir/nfcorpus/test | 3633 | 11770 | 0.31 | 5.1 MB | 0.00 | 0.00 | 0.00 |

Client round-trip latency (wall-clock around the HTTP call, includes transport and JSON), measured over the same queries and repeats:

| Dataset | Client p50 ms | Client p95 ms | Client p99 ms |
|---|---|---|---|
| beir/scifact/test | 0.93 | 1.23 | 1.55 |
| beir/nfcorpus/test | 0.57 | 0.69 | 0.80 |
...
|---|---|---|---|---|---|---|
| beir/scifact/test | num_candidates | 64 | 0.9940 | yes | 16 | 0.9527 |
...
| Dataset | Docs | Ingest docs/s | Build s | Index size | Server p50 ms | Server p95 ms | Server p99 ms |
|---|---|---|---|---|---|---|---|
| beir/scifact/test | 5183 | 1389 | 3.73 | 15.1 MB | 0.00 | 0.00 | 0.00 |
| beir/nfcorpus/test | 3633 | 1865 | 1.95 | 10.8 MB | 0.00 | 0.00 | 0.00 |

Client round-trip latency (wall-clock around the HTTP call, includes transport and JSON), measured over the same queries and repeats:

| Dataset | Client p50 ms | Client p95 ms | Client p99 ms |
|---|---|---|---|
| beir/scifact/test | 1.03 | 1.30 | 1.63 |
| beir/nfcorpus/test | 0.92 | 1.05 | 1.14 |
...
| Dataset | Docs | Ingest docs/s | Build s | Index size | Server p50 ms | Server p95 ms | Server p99 ms |
|---|---|---|---|---|---|---|---|
| beir/scifact/test | 5183 | 1725 | 3.00 | 15.1 MB | 0.00 | 1.00 | 1.00 |
| beir/nfcorpus/test | 3633 | 1841 | 1.97 | 10.8 MB | 0.00 | 0.00 | 0.00 |

Client round-trip latency (wall-clock around the HTTP call, includes transport and JSON), measured over the same queries and repeats:

| Dataset | Client p50 ms | Client p95 ms | Client p99 ms |
|---|---|---|---|
| beir/scifact/test | 1.46 | 2.04 | 3.01 |
| beir/nfcorpus/test | 1.19 | 1.33 | 1.41 |
