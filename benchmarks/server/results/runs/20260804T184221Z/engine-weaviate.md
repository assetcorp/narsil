...
- Captured: 2026-08-04T19:20:47.449808+00:00
...
| --- | --- | --- | --- | --- | --- | --- |
| beir/scifact/test | ef | 64 | 0.9950 | yes | 32 | 0.9807 |
| beir/nfcorpus/test | ef | 128 | 0.9929 | yes | 64 | 0.9774 |
...
| beir/nfcorpus/test | 3633 | 996 | 3.65 | n/a | n/a | n/a | n/a |

Client round-trip latency (wall-clock around the HTTP call, includes transport and JSON), measured over the same queries and repeats:

| Dataset | Client p50 ms | Client p95 ms | Client p99 ms |
| --- | --- | --- | --- |
| beir/scifact/test | 3.24 | 4.15 | 6.64 |
| beir/nfcorpus/test | 3.32 | 4.22 | 6.31 |
...
| beir/nfcorpus/test | 0.3427 | 0.3180 | 0.1811 | 0.5584 |

Operational metrics. Latency below is the engine's own reported query time (server-side); the client round-trip is reported separately underneath.

| Dataset | Docs | Ingest docs/s | Build s | Index size | Server p50 ms | Server p95 ms | Server p99 ms |
| --- | --- | --- | --- | --- | --- | --- | --- |
| beir/scifact/test | 5183 | 1018 | 5.09 | n/a | n/a | n/a | n/a |
| beir/nfcorpus/test | 3633 | 1013 | 3.59 | n/a | n/a | n/a | n/a |

Client round-trip latency (wall-clock around the HTTP call, includes transport and JSON), measured over the same queries and repeats:

| Dataset | Client p50 ms | Client p95 ms | Client p99 ms |
| --- | --- | --- | --- |
| beir/scifact/test | 4.38 | 5.90 | 10.53 |
| beir/nfcorpus/test | 4.06 | 5.34 | 8.79 |
